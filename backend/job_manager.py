...
# Frontend-only meta-params that must NOT be forwarded to the relion binary
...
def validate_job_submission(job_type: str, params: Dict[str, Any], project_dir: str = '') -> None:
    ...
    and the workflow endpoints. Raises ValueError on
        ...
        try:
            ...
            for key, value in params.items():
                ...
                # MotionRefine (Bayesian Polishing) special handling
                    ...
                    # Accept frontend RADIO ('RELION'/'MotionCor2') and SDK
