...
- **AI-assisted features.** Any chat interface, natural-language job submission, or history-aware parameter suggestions live outside this repo. This project stays focused on the browser pipeline + Slurm submission.
